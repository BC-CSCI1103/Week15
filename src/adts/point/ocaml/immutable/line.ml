 ...
 *)
type t = { p1 : Point.t  (* choosing a record with 2 floats for t *)
         ; p2 : Point.t
         }
...
let compare line1 line2 =
  let line1MP = midpoint line1 in
  let line2MP = midpoint line2
  in
	Point.compare line1MP line2MP

let equal line1 line2 = (compare line1 line2) = 0

let move line dx dy =
  let p1 = Point.move (getP1 line) dx dy in
  let p2 = Point.move (getP2 line) dx dy
  in
	make p1 p2
